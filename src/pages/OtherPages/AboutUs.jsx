        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
            ...
            >
              ...
              <p className="text-[#475569]">
                To become the most trusted digital garment supply chain
                ecosystem that connects global brands with efficient and
                transparent factories worldwide.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-[#475569]">
                Monitor cutting, sewing, finishing, QC, and packing in
                real-time.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[#475569]">
                Teams work together seamlessly — merchandiser to factory to
                buyer.
              </p>
            </motion.div>
